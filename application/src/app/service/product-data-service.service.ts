...
export class ProductDataServiceService {
  ...
  products(){
    return of([
      { id:"1", productName:"Fruits", productAvailableQuantity:25, productImage:"./assets/images/strawberries.jpeg", productPrice: 200, productCategory:"fruits" },
      ...
      { id:"6", productName:"Pizza", productAvailableQuantity:25, productImage:"./assets/images/mouse.jpg", productPrice: 200, productCategory:"pizza" },
